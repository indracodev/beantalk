"use strict";var BeanTalk=(()=>{var H=Object.defineProperty;var Z=Object.getOwnPropertyDescriptor;var X=Object.getOwnPropertyNames;var ee=Object.prototype.hasOwnProperty;var te=(n,e)=>{for(var t in e)H(n,t,{get:e[t],enumerable:!0})},ie=(n,e,t,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of X(e))!ee.call(n,s)&&s!==t&&H(n,s,{get:()=>e[s],enumerable:!(i=Z(e,s))||i.enumerable});return n};var ne=n=>ie(H({},"__esModule",{value:!0}),n);var ye={};te(ye,{BeanTalk:()=>S,ChatWidget:()=>g,UniversalChatMe:()=>de,close:()=>ue,default:()=>ve,getInstance:()=>be,init:()=>pe,on:()=>me,open:()=>he,sendMessage:()=>xe,toggle:()=>ge});var M=class{constructor(){this.events={}}on(e,t){return this.events[e]||(this.events[e]=[]),this.events[e].push(t),this}off(e,t){return this.events[e]?(this.events[e]=this.events[e].filter(i=>i!==t),this):this}emit(e,t){this.events[e]&&this.events[e].forEach(i=>{try{i(t)}catch(s){console.error(`[BeanTalk] Error in event handler for "${e}":`,s)}})}};var B=class{constructor(e,t=""){this.projectKey=e,this.baseUrl=t.replace(/\/+$/,"")}async request(e,t={}){let i=`${this.baseUrl}${e}`,s={Accept:"application/json","Content-Type":"application/json","X-Project-Key":this.projectKey,...t.headers||{}},a=new AbortController,l=setTimeout(()=>a.abort(),12e3);try{let o=await fetch(i,{...t,headers:s,signal:a.signal});return clearTimeout(l),await o.json()}catch(o){return clearTimeout(l),{success:!1,error:{code:o.name==="AbortError"?"TIMEOUT":"NETWORK_ERROR",message:o.message||"Gagal terhubung ke server chat."}}}}async initSession(e,t,i){return this.request("/api/v1/client/session/init",{method:"POST",body:JSON.stringify({visitor_uuid:e,name:i,project_key:this.projectKey,page_url:window.location.href,page_title:document.title,client_url:window.location.href,metadata:{referrer:document.referrer,userAgent:navigator.userAgent,title:document.title,...t}})})}async updateProfile(e,t){return this.request("/api/v1/client/session/profile",{method:"POST",body:JSON.stringify({visitor_uuid:e,name:t})})}async pollMessages(e,t=0){return this.request(`/api/v1/client/conversations/${e}/messages?after_id=${t}`,{method:"GET"})}async sendMessage(e,t){let i=e&&e>0?e:0;return this.request(`/api/v1/client/conversations/${i}/messages`,{method:"POST",body:JSON.stringify({visitor_uuid:t.visitor_uuid,client_message_id:t.client_message_id,content:t.message,message:t.message,sender_name:t.sender_name,page_url:t.page_url,page_title:t.page_title})})}};var W="beantalk_visitor_uuid",se="beantalk_last_conv_id",q={};function V(n){try{return window.localStorage.getItem(n)}catch{return q[n]||null}}function O(n,e){try{window.localStorage.setItem(n,e)}catch{q[n]=e}}function ae(){return typeof crypto<"u"&&typeof crypto.randomUUID=="function"?crypto.randomUUID():"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,n=>{let e=Math.random()*16|0;return(n==="x"?e:e&3|8).toString(16)})}function C(){return"msg_"+Date.now().toString(36)+"_"+Math.random().toString(36).substring(2,9)}function L(){let n=V(W);return n||(n=ae(),O(W,n)),n}function P(n){O(se,n.toString())}var G="beantalk_customer_name";function T(){return V(G)}function K(n){O(G,n)}var R=class{constructor(e,t,i={}){this.conversationId=null;this.lastMessageId=0;this.isRunning=!1;this.isPolling=!1;this.pollQueued=!1;this.timer=null;this.isWindowVisible=!0;this.isOnline=!0;this.isWidgetOpen=!1;this.burstRemaining=0;this.burstIntervalMs=1200;this.api=e,this.emitter=t,this.activeIntervalMs=i.activeIntervalMs||2500,this.idleIntervalMs=i.idleIntervalMs||15e3,this.setupListeners()}setupListeners(){typeof document<"u"&&document.addEventListener("visibilitychange",()=>{let e=document.visibilityState==="visible";this.isWindowVisible=e,e&&this.isRunning&&this.pollNow()}),typeof window<"u"&&(window.addEventListener("online",()=>{this.isOnline=!0,this.isRunning&&this.pollNow()}),window.addEventListener("offline",()=>{this.isOnline=!1,this.clearTimer()}))}setConversation(e,t=0){this.conversationId=e,t>this.lastMessageId&&(this.lastMessageId=t)}setWidgetOpen(e){this.isWidgetOpen=e,this.isRunning&&this.reschedule()}start(e,t=0){this.conversationId=e,this.lastMessageId=Math.max(this.lastMessageId,t),this.isRunning=!0,this.reschedule()}stop(){this.isRunning=!1,this.clearTimer()}clearTimer(){this.timer&&(clearTimeout(this.timer),this.timer=null)}getInterval(){return this.burstRemaining>0?this.burstIntervalMs:this.isWindowVisible&&this.isWidgetOpen?this.activeIntervalMs:this.idleIntervalMs}reschedule(){this.clearTimer(),!(!this.isRunning||!this.isOnline)&&(this.timer=setTimeout(()=>{this.executePoll()},this.getInterval()))}async pollNow(){if(this.isPolling){this.pollQueued=!0;return}this.clearTimer(),this.burstRemaining=3,await this.executePoll()}async executePoll(){if(!this.isRunning||!this.conversationId||!this.isOnline||this.isPolling){this.reschedule();return}this.isPolling=!0;try{let e=await this.api.pollMessages(this.conversationId,this.lastMessageId);if(e.success&&e.data){let{messages:t,last_id:i}=e.data;if(Array.isArray(t)&&t.length>0){let s=t.filter(a=>a.id>this.lastMessageId);s.length>0&&s.forEach(a=>{this.emitter.emit("message:received",a)}),i&&i>this.lastMessageId&&(this.lastMessageId=i)}}}catch(e){this.emitter.emit("poll:error",e)}finally{this.isPolling=!1,this.burstRemaining>0&&this.burstRemaining--,this.pollQueued?(this.pollQueued=!1,this.burstRemaining=2,this.clearTimer(),this.timer=setTimeout(()=>this.executePoll(),100)):this.reschedule()}}};var r={chat:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  `}function oe(n,e){let t=parseInt(n.replace("#",""),16),i=(t>>16)+e,s=(t>>8&255)+e,a=(t&255)+e;return i=Math.min(255,Math.max(0,i)),s=Math.min(255,Math.max(0,s)),a=Math.min(255,Math.max(0,a)),"#"+(s|a<<8|i<<16).toString(16).padStart(6,"0")}var _=class{constructor(e,t){this.isOpen=!1;this.currentStage="welcome";this.unreadCount=0;this.messages=[];this.sessionData=null;this.customerName="";this.customerCode="";this.audioCtx=null;this.options=e,this.emitter=t;let i=document.getElementById("beantalk-chat-root")||document.getElementById("universal-chat-root");i||(i=document.createElement("div"),i.id="beantalk-chat-root",i.style.position="relative",i.style.zIndex="2147483647",i.style.display="block",document.body.appendChild(i)),this.shadowRoot=i.attachShadow({mode:"open"}),this.styleEl=document.createElement("style"),this.styleEl.textContent=D(e.accentColor||"#1E1E1E"),this.shadowRoot.appendChild(this.styleEl),this.renderSkeleton(),this.bindEvents(),this.initViewportHandler();let s=T();s&&this.applyCustomerName(s,!1)}updateTheming(e){this.styleEl&&(this.styleEl.textContent=D(e))}setSessionData(e){this.sessionData=e;let t=e.widget||e.widget_settings||{};t.primary_color&&this.updateTheming(t.primary_color);let i=t.greeting_title||t.header_title||e.project?.name||"Chat Support",s=t.greeting_subtitle||t.greeting_text||"Hallo! Ada yang bisa kami bantu? Tanyakan apapun di sini.",a=this.shadowRoot.querySelector(".welcome-title");a&&(a.textContent=i);let l=this.shadowRoot.querySelector(".welcome-subtitle");l&&(l.textContent=s);let o=t.support_title||this.options.supportTitle||this.options.brandName||this.options.storeName||e.project?.name||"Customer Support",p=this.shadowRoot.querySelector("#cardChatName");p&&(p.textContent=o),this.identitySupportTag&&(this.identitySupportTag.textContent=o);let c=this.shadowRoot.querySelector(".chat-header-title");c&&(c.textContent=o);let y=this.shadowRoot.querySelector(".welcome-brand-badge");y&&(y.textContent=e.project?.name||"Live Support");let u=e.visitor||{},x=u.customer_code||u.customer_code_formatted;x&&(this.customerCode=x,this.identityCustCode&&(this.identityCustCode.textContent=x));let w=u.name,k=T(),A=w||k;A?this.applyCustomerName(A,!1):this.chatInlineIdentityBanner&&(this.chatInlineIdentityBanner.style.display="flex"),e.conversation?.messages&&e.conversation.messages.length>0&&this.setMessages(e.conversation.messages);let F=this.shadowRoot.querySelector("#socialChannelsCard"),v=this.shadowRoot.querySelector("#socialChannelsTitle"),E=this.shadowRoot.querySelector("#socialChannelsRow"),j=t.social_channels||[],Y=t.find_us_title||"Reach Us Anywhere Else";if(v&&(v.textContent=Y),F&&E){let z=Array.isArray(j)?j.filter(f=>f.enabled&&f.url):[];if(z.length>0){E.innerHTML="";let f={};z.forEach(h=>{let b=(h.platform||h.icon||h.id||"whatsapp").toLowerCase();f[b]||(f[b]=[]),f[b].push(h)}),Object.keys(f).forEach(h=>{let b=f[h],N=b[0],Q=N.icon||h,U=r[Q]||r[h]||r.chat;if(b.length===1){let d=document.createElement("a");d.className=`social-channel-btn social-btn-${h}`,d.href=N.url,d.target="_blank",d.rel="noopener noreferrer",d.title=`Hubungi via ${N.name||$(h)}`,d.innerHTML=U,E.appendChild(d)}else{let d=document.createElement("button");d.type="button",d.className=`social-channel-btn social-btn-${h} has-multi-badge`,d.title=`${$(h)} (${b.length} pilihan kontak)`,d.innerHTML=`
              ${U}
              <span class="social-channel-badge">${b.length}</span>
            `,d.addEventListener("click",J=>{J.stopPropagation(),this.openSocialPicker(h,b)}),E.appendChild(d)}}),F.style.display="block"}else F.style.display="none"}}applyCustomerName(e,t=!0){let i=e.trim();i&&(this.customerName=i,t&&(K(i),this.emitter.emit("customer:rename",i)),this.identityNameInput&&(this.identityNameInput.value=i),this.chatInlineIdentityBanner&&(this.chatInlineIdentityBanner.style.display="none"),this.composerInput&&(this.composerInput.placeholder=`Tulis pesan sebagai ${i}...`))}renderSkeleton(){let e=this.options.brandName||this.options.storeName||"Customer Support",t=this.options.supportTitle||e||"Customer Support",i=this.options.greetingTitle||"Hallo!",s=this.options.greetingSubtitle||"Apakah ada yang bisa kami bantu? Tanyakan informasi apapun di sini.",l=`
    ...
    `,u&&u.length>0&&!t){let w=s.querySelectorAll(".msg-option-btn");w.forEach((k,A)=>{k.addEventListener("click",F=>{F.preventDefault();let v=u[A];v&&(w.forEach(E=>E.disabled=!0),k.classList.add("is-selected"),this.handleSendText(v.value||v.label,v.label||v.value))})})}this.messagesArea.appendChild(s)}formatMessageContent(e){if(!e)return"";let t=I(e);return t=t.replace(/\*(.*?)\*/g,"<strong>$1</strong>"),t=t.replace(/(https?:\/\/[^\s]+)/g,'<a href="$1" target="_blank" rel="noopener noreferrer">$1</a>'),t=t.replace(/(^|[\s])(www\.[^\s]+)/g,'$1<a href="https://$2" target="_blank" rel="noopener noreferrer">$2</a>'),t}updateSnippet(){if(this.messages.length>0){let e=this.messages[this.messages.length-1],t=e.sender_type==="visitor"?"Anda: ":"",i=e.content||e.message||"";this.cardSnippetText.textContent=t+i}}updateUnreadBadge(){this.unreadCount>0?(this.unreadBadge.textContent=this.unreadCount>9?"9+":this.unreadCount.toString(),this.unreadBadge.classList.add("has-unread")):this.unreadBadge.classList.remove("has-unread")}scrollToBottom(){setTimeout(()=>{this.messagesArea.scrollTop=this.messagesArea.scrollHeight},40)}formatTime(e){try{if(!e)return"";let t=e;typeof t=="string"&&!t.includes("Z")&&!t.includes("+")&&!t.includes("T")&&(t=t.replace(" ","T")+"Z");let i=new Date(t);if(isNaN(i.getTime()))return"";let s=String(i.getHours()).padStart(2,"0"),a=String(i.getMinutes()).padStart(2,"0");return`${s}:${a}`}catch{return""}}};function I(n){return n.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function $(n){return{whatsapp:"WhatsApp",instagram:"Instagram",telegram:"Telegram",messenger:"Facebook Messenger",shopee:"Shopee Store",tokopedia:"Tokopedia Store",custom:"Link Kustom",link:"Tautan Kustom"}[n.toLowerCase()]||le(n)}function re(n,e){if(!n)return"";let t=e.toLowerCase();if(t==="whatsapp"){if(n.includes("wa.me/")){let i=n.split("wa.me/")[1]?.split("?")[0]||"";return i?`+${i}`:n}}else if(t==="instagram"){if(n.includes("instagram.com/")){let i=n.split("instagram.com/")[1]?.split("/")[0]?.split("?")[0]||"";return i?`@${i}`:n}}else if(t==="telegram"&&n.includes("t.me/")){let i=n.split("t.me/")[1]?.split("/")[0]?.split("?")[0]||"";return i?`@${i}`:n}return n}function le(n){return n?n.charAt(0).toUpperCase()+n.slice(1):""}function ce(){if(typeof document>"u")return"";let n=document.currentScript;if(n&&n.src)try{return new URL(n.src,window.location.href).origin}catch{}let e=document.querySelector("script[data-project-key]");if(e&&e.src)try{return new URL(e.src,window.location.href).origin}catch{}let t=document.querySelector('script[src*="chat-widget.js"], script[src*="widget.js"]');if(t&&t.src)try{return new URL(t.src,window.location.href).origin}catch{}return""}if(typeof window<"u")try{console.log("%c[BeanTalk]%c Universal Chat Widget Started","background: #0071E3; color: #ffffff; padding: 2px 6px; border-radius: 4px; font-weight: bold;","color: inherit; font-weight: 500;")}catch{}var S=class{constructor(e){this.sessionData=null;this.initialized=!1;this.sendQueue=[];this.isSending=!1;this.options=e,this.emitter=new M,console.log("[BeanTalk] Initializing widget instance for project:",e.projectKey);let t=ce(),i=e.apiUrl||t||(typeof window<"u"?window.location.origin:"");this.api=new B(e.projectKey,i),this.ui=new _(e,this.emitter),this.transport=new R(this.api,this.emitter),this.bindEvents(),this.bootstrap()}isReady(){return this.initialized}async processSendQueue(){if(!(this.isSending||this.sendQueue.length===0)){for(this.isSending=!0;this.sendQueue.length>0;){let e=this.sendQueue.shift(),t=this.sessionData?.conversation?.id||0,i=this.options.visitorUuid||L(),s=T();try{let a=await this.api.sendMessage(t,{visitor_uuid:i,client_message_id:e.client_message_id||C(),message:e.content||e.message||"",sender_name:e.sender_name||s||"Tamu",page_url:window.location.href,page_title:document.title});if(a.success&&a.data){let l=a.data.conversation_id;l&&(!this.sessionData?.conversation?.id||this.sessionData.conversation.id!==l)&&(this.sessionData||(this.sessionData={}),this.sessionData.conversation?this.sessionData.conversation.id=l:this.sessionData.conversation={id:l,status:"open"},P(l),this.transport.start(l,a.data.id||0)),this.emitter.emit("message:sent",a.data)}}catch(a){console.error("[BeanTalk] Gagal mengirim pesan:",a)}}this.isSending=!1,this.transport.pollNow()}}bindEvents(){this.emitter.on("ui:send",e=>{this.sendQueue.push(e),this.processSendQueue()}),this.emitter.on("customer:rename",async e=>{let t=this.options.visitorUuid||L();try{await this.api.updateProfile(t,e)}catch(i){console.warn("[BeanTalk] Gagal update nama profil pengunjung:",i)}}),this.emitter.on("message:received",e=>{this.ui.appendMessage(e),this.emitter.emit("message",e)}),this.emitter.on("widget:opened",()=>{this.transport.setWidgetOpen(!0),this.transport.pollNow()}),this.emitter.on("widget:closed",()=>{this.transport.setWidgetOpen(!1)})}async bootstrap(){let e=this.options.visitorUuid||L(),t=T();try{let i=await this.api.initSession(e,void 0,t||void 0);if(i.success&&i.data){this.sessionData=i.data,this.ui.setSessionData(i.data);let s=i.data.conversation;if(s&&s.id){P(s.id);let a=0;s.messages&&s.messages.length>0&&(a=Math.max(...s.messages.map(l=>l.id))),this.transport.start(s.id,a)}this.initialized=!0,console.log("[BeanTalk] Session established successfully:",{brand:i.data.project?.name,customerCode:i.data.visitor?.customer_code,conversationId:i.data.conversation?.id||"New Thread"}),this.emitter.emit("ready",i.data)}else console.warn("[BeanTalk] Init session warning:",i.error?.message)}catch(i){console.error("[BeanTalk] Failed to initialize chat session:",i)}}open(){console.log("[BeanTalk] Opening chat widget window"),this.ui.open()}close(){console.log("[BeanTalk] Closing chat widget window"),this.ui.close()}toggle(){this.ui.toggle()}on(e,t){return this.emitter.on(e,t),this}sendMessage(e){if(!e.trim())return;let t={id:Date.now(),conversation_id:this.sessionData?.conversation?.id||0,client_message_id:C(),sender_type:"visitor",sender_name:"Anda",content:e.trim(),message:e.trim(),created_at:new Date().toISOString()};this.ui.appendMessage(t),this.emitter.emit("ui:send",t)}},de=S,m=null,pe=n=>g.init(n),he=()=>g.open(),ue=()=>g.close(),ge=()=>g.toggle(),me=(n,e)=>g.on(n,e),xe=n=>g.sendMessage(n),be=()=>g.getInstance(),g={init(n){return m||(console.log("[BeanTalk] Creating singleton widget instance"),m=new S(n)),m},open(){m?m.open():console.warn("[BeanTalk] Widget instance not yet initialized")},close(){m?.close()},toggle(){m?.toggle()},on(n,e){m?.on(n,e)},sendMessage(n){m?.sendMessage(n)},getInstance(){return m}};if(typeof window<"u"){let n=function(){let e=document.querySelectorAll("script[data-project-key]");if(e.length>0){let t=e[0],i=t.getAttribute("data-project-key"),s="";if(t.src)try{s=new URL(t.src,window.location.href).origin}catch{}let a=t.getAttribute("data-api-url")||s||void 0,l=t.getAttribute("data-color")||void 0,o=t.getAttribute("data-brand-name")||t.getAttribute("data-store-name")||void 0,p=t.getAttribute("data-support-title")||void 0;console.log("[BeanTalk] Found embed tag on page:",{projectKey:i,apiUrl:a,brandName:o}),i&&!m&&g.init({projectKey:i,apiUrl:a,accentColor:l,brandName:o,storeName:o,supportTitle:p})}};fe=n,window.ChatWidget=g,window.UniversalChatMe=S,setTimeout(()=>{try{window.BeanTalk&&Object.assign(window.BeanTalk,g)}catch{}},0),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()}var fe,ve=g;return ne(ye);})();
