"use strict";var BeanTalk=(()=>{var z=Object.defineProperty;var lt=Object.getOwnPropertyDescriptor;var ct=Object.getOwnPropertyNames;var dt=Object.prototype.hasOwnProperty;var pt=(n,t)=>{for(var e in t)z(n,e,{get:t[e],enumerable:!0})},ht=(n,t,e,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let a of ct(t))!dt.call(n,a)&&a!==e&&z(n,a,{get:()=>t[a],enumerable:!(i=lt(t,a))||i.enumerable});return n};var ut=n=>ht(z({},"__esModule",{value:!0}),n);var Lt={};pt(Lt,{BeanTalk:()=>T,ChatWidget:()=>m,UniversalChatMe:()=>xt,close:()=>Et,default:()=>Ft,getInstance:()=>At,init:()=>wt,on:()=>Tt,open:()=>kt,sendMessage:()=>St,setLanguage:()=>Bt,toggle:()=>Ct});var R=class{constructor(){this.events={}}on(t,e){return this.events[t]||(this.events[t]=[]),this.events[t].push(e),this}off(t,e){return this.events[t]?(this.events[t]=this.events[t].filter(i=>i!==e),this):this}emit(t,e){this.events[t]&&this.events[t].forEach(i=>{try{i(e)}catch(a){console.error(`[BeanTalk] Error in event handler for "${t}":`,a)}})}};var H=class{constructor(t,e=""){this.projectKey=t,this.baseUrl=e.replace(/\/+$/,"")}async request(t,e={}){let i=`${this.baseUrl}${t}`,a={Accept:"application/json","Content-Type":"application/json","X-Project-Key":this.projectKey,...e.headers||{}},s=new AbortController,r=setTimeout(()=>s.abort(),12e3);try{let o=await fetch(i,{...e,headers:a,signal:s.signal});return clearTimeout(r),await o.json()}catch(o){return clearTimeout(r),{success:!1,error:{code:o.name==="AbortError"?"TIMEOUT":"NETWORK_ERROR",message:o.message||"Gagal terhubung ke server chat."}}}}async initSession(t,e,i){return this.request("/api/v1/client/session/init",{method:"POST",body:JSON.stringify({visitor_uuid:t,name:i,project_key:this.projectKey,page_url:window.location.href,page_title:document.title,client_url:window.location.href,metadata:{referrer:document.referrer,userAgent:navigator.userAgent,title:document.title,...e}})})}async updateProfile(t,e){return this.request("/api/v1/client/session/profile",{method:"POST",body:JSON.stringify({visitor_uuid:t,name:e})})}async pollMessages(t,e=0){return this.request(`/api/v1/client/conversations/${t}/messages?after_id=${e}`,{method:"GET"})}async sendMessage(t,e){let i=t&&t>0?t:0;return this.request(`/api/v1/client/conversations/${i}/messages`,{method:"POST",body:JSON.stringify({visitor_uuid:e.visitor_uuid,client_message_id:e.client_message_id,content:e.message,message:e.message,sender_name:e.sender_name,page_url:e.page_url,page_title:e.page_title})})}async resolveConversation(t,e){return this.request(`/api/v1/client/conversations/${t}/resolve`,{method:"POST",body:JSON.stringify({visitor_uuid:e})})}async getConversations(t){return this.request(`/api/v1/client/conversations?visitor_uuid=${encodeURIComponent(t)}`,{method:"GET"})}};var Z="beantalk_visitor_uuid",gt="beantalk_last_conv_id",tt={};function j(n){try{return window.localStorage.getItem(n)}catch{return tt[n]||null}}function N(n,t){try{window.localStorage.setItem(n,t)}catch{tt[n]=t}}function mt(){return typeof crypto<"u"&&typeof crypto.randomUUID=="function"?crypto.randomUUID():"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,n=>{let t=Math.random()*16|0;return(n==="x"?t:t&3|8).toString(16)})}function B(){return"msg_"+Date.now().toString(36)+"_"+Math.random().toString(36).substring(2,9)}function A(){let n=j(Z);return n||(n=mt(),N(Z,n)),n}function F(n){N(gt,n.toString())}var et="beantalk_customer_name";function E(){return j(et)}function it(n){N(et,n)}var nt="beantalk_customer_email";function U(){return j(nt)}function st(n){N(nt,n)}var _=class{constructor(t,e,i={}){this.conversationId=null;this.lastMessageId=0;this.isRunning=!1;this.isPolling=!1;this.pollQueued=!1;this.timer=null;this.isWindowVisible=!0;this.isOnline=!0;this.isWidgetOpen=!1;this.burstRemaining=0;this.burstIntervalMs=1200;this.api=t,this.emitter=e,this.activeIntervalMs=i.activeIntervalMs||2500,this.idleIntervalMs=i.idleIntervalMs||15e3,this.setupListeners()}setupListeners(){typeof document<"u"&&document.addEventListener("visibilitychange",()=>{let t=document.visibilityState==="visible";this.isWindowVisible=t,t&&this.isRunning&&this.pollNow()}),typeof window<"u"&&(window.addEventListener("online",()=>{this.isOnline=!0,this.isRunning&&this.pollNow()}),window.addEventListener("offline",()=>{this.isOnline=!1,this.clearTimer()}))}setConversation(t,e=0){this.conversationId=t,e>this.lastMessageId&&(this.lastMessageId=e)}setWidgetOpen(t){this.isWidgetOpen=t,this.isRunning&&this.reschedule()}start(t,e=0){this.conversationId=t,this.lastMessageId=Math.max(this.lastMessageId,e),this.isRunning=!0,this.reschedule()}stop(){this.isRunning=!1,this.clearTimer()}clearTimer(){this.timer&&(clearTimeout(this.timer),this.timer=null)}getInterval(){return this.burstRemaining>0?this.burstIntervalMs:this.isWindowVisible&&this.isWidgetOpen?this.activeIntervalMs:this.idleIntervalMs}reschedule(){this.clearTimer(),!(!this.isRunning||!this.isOnline)&&(this.timer=setTimeout(()=>{this.executePoll()},this.getInterval()))}async pollNow(){if(this.isPolling){this.pollQueued=!0;return}this.clearTimer(),this.burstRemaining=3,await this.executePoll()}async executePoll(){if(!this.isRunning||!this.conversationId||!this.isOnline||this.isPolling){this.reschedule();return}this.isPolling=!0;try{let t=await this.api.pollMessages(this.conversationId,this.lastMessageId);if(t.success&&t.data){let{messages:e,last_id:i}=t.data;if(Array.isArray(e)&&e.length>0){let a=e.filter(s=>s.id>this.lastMessageId);a.length>0&&a.forEach(s=>{this.emitter.emit("message:received",s)}),i&&i>this.lastMessageId&&(this.lastMessageId=i)}}}catch(t){this.emitter.emit("poll:error",t)}finally{this.isPolling=!1,this.burstRemaining>0&&this.burstRemaining--,this.pollQueued?(this.pollQueued=!1,this.burstRemaining=2,this.clearTimer(),this.timer=setTimeout(()=>this.executePoll(),100)):this.reschedule()}}};var d={chat:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  </svg>`};function W(n="#1E1E1E"){return`
    :host {
      all: initial;
  ...
  `}function ft(n,t){let e=parseInt(n.replace("#",""),16),i=(e>>16)+t,a=(e>>8&255)+t,s=(e&255)+t;return i=Math.min(255,Math.max(0,i)),a=Math.min(255,Math.max(0,a)),s=Math.min(255,Math.max(0,s)),"#"+(a|s<<8|i<<16).toString(16).padStart(6,"0")}var V={id:{liveChatAvailable:"Live Chat Aktif",newChatSnippet:"Mulai obrolan baru dengan tim kami...",ticketsTitle:"Tiket & Riwayat Chat",startNewChat:"Mulai Chat Baru",findUsTitleDefault:"Reach Us Anywhere Else",poweredBy:"Powered by BeanTalk \u2022 Web Chat",identityPillGuest:"Tamu",identityTitle:"Halo! Kenalan Dulu Yuk",identitySubtitle:"Boleh kami tahu nama panggilan Anda? Agar tim CS kami dapat menyapa Anda dengan ramah.",identityLabel:"Nama Panggilan Anda",identityPlaceholder:"Contoh: Budi, Sarah, Alex...",identityEmailLabel:"Alamat Email",identityEmailPlaceholder:"Contoh: budi@gmail.com",identityEmailRequired:"Email wajib diisi agar riwayat chat bisa dikirim ke Anda.",identityContinue:"Lanjut ke Obrolan",socialPickerTitle:n=>`Hubungi via ${n}`,socialPickerHeader:n=>`Pilih Kontak ${n}`,socialPickerSubtitle:"Pilih salah satu kontak layanan di bawah untuk terhubung langsung:",socialPickerContactChoice:n=>`(${n} pilihan kontak)`,contactVia:n=>`Hubungi via ${n}`,onlineStatus:"Online \u2022 Membalas dalam hitungan menit",resolveBtn:"Selesaikan",resolveConfirm:"Apakah Anda ingin menyelesaikan tiket percakapan ini?",resolvedBanner:"Tiket percakapan ini telah selesai.",resolvedSystemNotice:'Percakapan ini telah Anda tandai selesai. Klik "Mulai Chat Baru" untuk membuat tiket baru.',askNameInline:"Boleh tahu nama Anda?",namePlaceholder:"Nama Anda...",saveBtn:"Simpan",typeMessagePlaceholder:"Tulis pesan ke CS...",typeMessageAsPlaceholder:n=>`Tulis pesan sebagai ${n}...`,ticketsCount:n=>`${n} Tiket`,ticketPrefix:n=>`Tiket #${n}`,ticketStatusOpen:"Open",ticketStatusClosed:"Selesai",ticketDefaultSnippet:"Percakapan tiket...",senderYou:"Anda",closeAriaLabel:"Tutup",backAriaLabel:"Kembali",sendAriaLabel:"Kirim",openChatAriaLabel:"Buka Chat",defaultGreetingTitle:"Hallo!",defaultGreetingSubtitle:"Ada yang bisa kami bantu? Tanyakan informasi apapun di sini!",defaultSupportTitle:"Customer Support",offHoursBanner:"Saat ini di luar jam kerja. Pesan Anda tetap kami terima dan akan dibalas via email."},en:{liveChatAvailable:"Live Chat Available",newChatSnippet:"Start a new conversation with our team...",ticketsTitle:"Tickets & Chat History",startNewChat:"Start New Chat",findUsTitleDefault:"Reach Us Anywhere Else",poweredBy:"Powered by BeanTalk \u2022 Web Chat",identityPillGuest:"Guest",identityTitle:"Hello! Let's get acquainted",identitySubtitle:"May we know your name so our support team can address you personally?",identityLabel:"Your Name / Nickname",identityPlaceholder:"E.g. Alex, Sarah, John...",identityEmailLabel:"Email Address",identityEmailPlaceholder:"E.g. alex@gmail.com",identityEmailRequired:"Email is required so we can send you the chat history.",identityContinue:"Continue to Chat",socialPickerTitle:n=>`Contact via ${n}`,socialPickerHeader:n=>`Choose ${n} Contact`,socialPickerSubtitle:"Choose one of our service contacts below to connect directly:",socialPickerContactChoice:n=>`(${n} contact options)`,contactVia:n=>`Contact via ${n}`,onlineStatus:"Online \u2022 Replies within minutes",resolveBtn:"Resolve",resolveConfirm:"Do you want to resolve this conversation ticket?",resolvedBanner:"This conversation ticket has ended.",resolvedSystemNotice:'You have marked this conversation as resolved. Click "Start New Chat" to open a new ticket.',askNameInline:"What is your name?",namePlaceholder:"Your name...",saveBtn:"Save",typeMessagePlaceholder:"Type a message to support...",typeMessageAsPlaceholder:n=>`Type a message as ${n}...`,ticketsCount:n=>`${n} Tickets`,ticketPrefix:n=>`Ticket #${n}`,ticketStatusOpen:"Open",ticketStatusClosed:"Closed",ticketDefaultSnippet:"Ticket conversation...",senderYou:"You",closeAriaLabel:"Close",backAriaLabel:"Back",sendAriaLabel:"Send",openChatAriaLabel:"Open Chat",defaultGreetingTitle:"Hello!",defaultGreetingSubtitle:"How can we help you today? Ask anything here!",defaultSupportTitle:"Customer Support",offHoursBanner:"Currently outside business hours. Your message will be replied to via email."}};var $=class{constructor(t,e){this.lang="id";this.isOpen=!1;this.currentStage="welcome";this.unreadCount=0;this.messages=[];this.sessionData=null;this.customerName="";this.customerEmail="";this.customerCode="";this.audioCtx=null;this.widgetSoundEnabled=!0;this.widgetSoundType="chime";this.widgetSoundCustomUrl=null;this.options=t,this.emitter=e,this.lang=t.language==="en"?"en":"id";let i=document.getElementById("beantalk-chat-root")||document.getElementById("universal-chat-root");i?i.style.pointerEvents="none":(i=document.createElement("div"),i.id="beantalk-chat-root",i.style.position="relative",i.style.zIndex="2147483647",i.style.display="block",i.style.pointerEvents="none",document.body.appendChild(i)),this.shadowRoot=i.attachShadow({mode:"open"}),this.styleEl=document.createElement("style"),this.styleEl.textContent=W(t.accentColor||"#1E1E1E"),this.shadowRoot.appendChild(this.styleEl),this.renderSkeleton(),this.bindEvents(),this.initViewportHandler();let a=E();a&&this.applyCustomerName(a,!1);let s=U();s&&(this.customerEmail=s,this.identityEmailInput&&(this.identityEmailInput.value=s))}get t(){return V[this.lang]||V.id}getCustomerEmail(){return this.customerEmail}updateTheming(t){this.styleEl&&(this.styleEl.textContent=W(t))}setLanguage(t){this.lang=t==="en"?"en":"id";let e=this.shadowRoot.querySelector(".card-live-indicator span:last-child");e&&(e.textContent=this.t.liveChatAvailable),this.messages.length===0&&this.cardSnippetText?this.cardSnippetText.textContent=this.t.newChatSnippet:this.updateSnippet();let i=this.shadowRoot.querySelector(".tickets-section-header span:first-child");if(i&&(i.textContent=this.t.ticketsTitle),this.btnNewTicketWelcome){let l=this.btnNewTicketWelcome.querySelector("span");l&&(l.textContent=this.t.startNewChat)}let a=this.shadowRoot.querySelector(".welcome-footer span");a&&(a.textContent=this.t.poweredBy);let s=this.shadowRoot.querySelector(".welcome-title");s&&(this.lang==="en"&&(s.textContent==="Hallo!"||s.textContent==="Hallo")?s.textContent=this.t.defaultGreetingTitle:this.lang==="id"&&(s.textContent==="Hello!"||s.textContent==="Hello")&&(s.textContent=this.t.defaultGreetingTitle));let r=this.shadowRoot.querySelector(".welcome-subtitle");r&&(this.lang==="en"&&(r.textContent==="Ada yang bisa kami bantu? Tanyakan informasi apapun di sini!"||r.textContent==="Apakah ada yang bisa kami bantu? Tanyakan informasi apapun di sini!")?r.textContent=this.t.defaultGreetingSubtitle:this.lang==="id"&&r.textContent==="How can we help you today? Ask anything here!"&&(r.textContent=this.t.defaultGreetingSubtitle)),this.identityCustCode&&(!this.customerCode||this.identityCustCode.textContent==="Tamu"||this.identityCustCode.textContent==="Guest")&&(this.identityCustCode.textContent=this.customerCode||this.t.identityPillGuest);let o=this.shadowRoot.querySelector(".identity-stage-title");o&&(o.textContent=this.t.identityTitle);let c=this.shadowRoot.querySelector(".identity-stage-subtitle");c&&(c.textContent=this.t.identitySubtitle);let p=this.shadowRoot.querySelector(".identity-form-label:not(.identity-email-label)");p&&(p.textContent=this.t.identityLabel),this.identityNameInput&&(this.identityNameInput.placeholder=this.t.identityPlaceholder);let h=this.shadowRoot.querySelector(".identity-email-label");if(h&&(h.textContent=this.t.identityEmailLabel),this.identityEmailInput&&(this.identityEmailInput.placeholder=this.t.identityEmailPlaceholder),this.identityEmailError&&(this.identityEmailError.textContent=this.t.identityEmailRequired),this.identityContinueBtn){let l=this.identityContinueBtn.querySelector("span");l&&(l.textContent=this.t.identityContinue)}if(this.offHoursBanner){let l=this.offHoursBanner.querySelector(".off-hours-text"),v=this.sessionData?.widget_settings?.business_hours_off_message||this.sessionData?.widget?.business_hours_off_message||this.sessionData?.business_hours?.off_message;l&&!v&&(l.textContent=this.t.offHoursBanner)}let u=this.shadowRoot.querySelector(".chat-header-status");if(u&&(u.textContent=this.t.onlineStatus),this.chatEndBtn){this.chatEndBtn.title=this.t.resolveBtn;let l=this.chatEndBtn.querySelector("span");l&&(l.textContent=this.t.resolveBtn)}if(this.chatInlineIdentityBanner){let l=this.chatInlineIdentityBanner.querySelector("span");l&&(l.textContent=this.t.askNameInline)}if(this.inlineIdentityInput&&(this.inlineIdentityInput.placeholder=this.t.namePlaceholder),this.inlineIdentityBtn&&(this.inlineIdentityBtn.textContent=this.t.saveBtn),this.chatResolvedBanner){let l=this.chatResolvedBanner.querySelector(".chat-resolved-text span");l&&(l.textContent=this.t.resolvedBanner)}if(this.chatStartNewBtn){let l=this.chatStartNewBtn.querySelector("span");l&&(l.textContent=this.t.startNewChat)}this.composerInput&&(this.composerInput.placeholder=this.customerName?this.t.typeMessageAsPlaceholder(this.customerName):this.t.typeMessagePlaceholder),this.sessionData?.conversations&&this.renderTicketsHistory(this.sessionData.conversations),this.shadowRoot.querySelectorAll(".msg-bubble-row.is-visitor .msg-sender-name").forEach(l=>{l.textContent=this.customerName||this.t.senderYou})}setSessionData(t){this.sessionData=t;let e=t.widget||t.widget_settings||{};(e.language==="en"||e.language==="id")&&this.setLanguage(e.language),e.primary_color&&this.updateTheming(e.primary_color),e.sound_enabled!==void 0&&(this.widgetSoundEnabled=!!e.sound_enabled),e.sound_type&&(this.widgetSoundType=e.sound_type),e.sound_custom_url!==void 0&&(this.widgetSoundCustomUrl=e.sound_custom_url);let i=e.greeting_title||e.header_title;(!i||this.lang==="en"&&i==="Hallo!")&&(i=this.lang==="en"?"Hello!":t.project?.name||"Chat Support");let a=e.greeting_subtitle||e.greeting_text;(!a||this.lang==="en"&&(a==="Ada yang bisa kami bantu? Tanyakan informasi apapun di sini!"||a==="Hallo! Ada yang bisa kami bantu? Tanyakan apapun di sini."))&&(a=this.t.defaultGreetingSubtitle);let s=this.shadowRoot.querySelector(".welcome-title");s&&(s.textContent=i);let r=this.shadowRoot.querySelector(".welcome-subtitle");r&&(r.textContent=a);let o=e.support_title||this.options.supportTitle||this.options.brandName||this.options.storeName||t.project?.name||this.t.defaultSupportTitle,c=this.shadowRoot.querySelector("#cardChatName");c&&(c.textContent=o),this.identitySupportTag&&(this.identitySupportTag.textContent=o);let p=this.shadowRoot.querySelector(".chat-header-title");p&&(p.textContent=o);let h=this.shadowRoot.querySelector(".welcome-brand-badge");h&&(h.textContent=t.project?.name||"Live Support");let u=t.visitor||{},l=u.customer_code||u.customer_code_formatted;l&&(this.customerCode=l,this.identityCustCode&&(this.identityCustCode.textContent=l));let v=u.name,C=E(),I=v||C;I?this.applyCustomerName(I,!1):this.chatInlineIdentityBanner&&(this.chatInlineIdentityBanner.style.display="flex");let P=u.email,k=U(),S=P||k;S&&(this.customerEmail=S,this.identityEmailInput&&(this.identityEmailInput.value=S));let at=t.is_within_business_hours!==!1,O=t.business_hours;if(this.offHoursBanner)if(!at&&O&&O.enabled){let M=O.off_message||this.t.offHoursBanner,b=this.offHoursBanner.querySelector(".off-hours-text");b&&(b.textContent=M),this.offHoursBanner.style.display="flex"}else this.offHoursBanner.style.display="none";t.conversation?.messages&&t.conversation.messages.length>0&&this.setMessages(t.conversation.messages),this.renderTicketsHistory(t.conversations||[]);let K=t.conversation?t.conversation.status==="closed":!1;this.updateResolvedUI(K),t.conversation&&t.conversation.id&&!K&&this.goToStage("chat");let D=this.shadowRoot.querySelector("#socialChannelsCard"),Q=this.shadowRoot.querySelector("#socialChannelsTitle"),L=this.shadowRoot.querySelector("#socialChannelsRow"),J=e.social_channels||[],ot=e.find_us_title||"Reach Us Anywhere Else";if(Q&&(Q.textContent=ot),D&&L){let M=Array.isArray(J)?J.filter(b=>b.enabled&&b.url):[];if(M.length>0){L.innerHTML="";let b={};M.forEach(f=>{let x=(f.platform||f.icon||f.id||"whatsapp").toLowerCase();b[x]||(b[x]=[]),b[x].push(f)}),Object.keys(b).forEach(f=>{let x=b[f],q=x[0],X=G(q,f);if(x.length===1){let g=document.createElement("a");g.className=`social-channel-btn social-btn-${f}`,g.href=q.url,g.target="_blank",g.rel="noopener noreferrer",g.title=`Hubungi via ${q.name||Y(f)}`,g.innerHTML=X,L.appendChild(g)}else{let g=document.createElement("button");g.type="button",g.className=`social-channel-btn social-btn-${f} has-multi-badge`,g.title=`${Y(f)} (${x.length} pilihan kontak)`,g.innerHTML=`
              ${X}
              <span class="social-channel-badge">${x.length}</span>
            `,g.addEventListener("click",rt=>{rt.stopPropagation(),this.openSocialPicker(f,x)}),L.appendChild(g)}}),D.style.display="block"}else D.style.display="none"}}applyCustomerName(t,e=!0){let i=t.trim();i&&(this.customerName=i,e&&(it(i),this.emitter.emit("customer:rename",i)),this.identityNameInput&&(this.identityNameInput.value=i),this.chatInlineIdentityBanner&&(this.chatInlineIdentityBanner.style.display="none"),this.composerInput&&(this.composerInput.placeholder=this.t.typeMessageAsPlaceholder(i)))}renderSkeleton(){let t=this.options.brandName||this.options.storeName||this.t.defaultSupportTitle,e=this.options.supportTitle||t||this.t.defaultSupportTitle,i=this.options.greetingTitle||this.t.defaultGreetingTitle,a=this.options.greetingSubtitle||this.t.defaultGreetingSubtitle,r=`
        ...
        <div class="chat-window">
          ...
          <div class="stage-welcome">
            <div class="welcome-header">
              <div class="welcome-header-top">
                ...
                <button type="button" class="welcome-close-btn" aria-label="${this.t.closeAriaLabel}">${d.close}</button>
              </div>
              <h2 class="welcome-title">${i}</h2>
              <p class="welcome-subtitle">${a}</p>
            </div>
            ...
            <div class="welcome-footer">
              ${d.sparkles} <span>${this.t.poweredBy}</span>
            </div>
          </div>
          ...
          <div class="stage-identity" style="display: none;">
            <div class="identity-stage-header">
              <button type="button" class="identity-back-btn" id="identityBackBtn" aria-label="${this.t.backAriaLabel}">${d.back}</button>
          ...
          <div class="stage-social-picker" id="stageSocialPicker" style="display: none;">
            <div class="social-picker-header">
              <button type="button" class="social-picker-back-btn" id="socialPickerBackBtn" aria-label="${this.t.backAriaLabel}">${d.back}</button>
          ...
          <div class="stage-chat">
            <div class="chat-header">
              <div class="chat-header-left">
                <button type="button" class="chat-back-btn" aria-label="${this.t.backAriaLabel}">${d.back}</button>
              ...
              <div class="chat-header-actions" style="display: flex; align-items: center; gap: 6px;">
                ...
                <button type="button" class="chat-close-btn" aria-label="${this.t.closeAriaLabel}">${d.close}</button>
              </div>
            </div>
            ...
            <div class="chat-composer-box" id="chatComposerBox">
              ...
              <button type="button" class="composer-send-btn" aria-label="${this.t.sendAriaLabel}" disabled>${d.send}</button>
            </div>
          </div>
        </div>
    ...
    `,o=document.createElement("div");o.innerHTML=r,this.shadowRoot.appendChild(o.firstElementChild),this.wrapperEl=this.shadowRoot.querySelector(".chat-wrapper"),this.launcherBtn=this.shadowRoot.querySelector(".chat-launcher-btn"),this.unreadBadge=this.shadowRoot.querySelector(".launcher-unread-badge"),this.stageWelcome=this.shadowRoot.querySelector(".stage-welcome"),this.stageIdentity=this.shadowRoot.querySelector(".stage-identity"),this.stageChat=this.shadowRoot.querySelector(".stage-chat"),this.stageSocialPicker=this.shadowRoot.querySelector("#stageSocialPicker"),this.messagesArea=this.shadowRoot.querySelector(".chat-messages-area"),this.composerInput=this.shadowRoot.querySelector(".composer-textarea"),this.composerSendBtn=this.shadowRoot.querySelector(".composer-send-btn"),this.cardSnippetText=this.shadowRoot.querySelector("#card-snippet"),this.cardTicketsContainer=this.shadowRoot.querySelector("#cardTicketsContainer"),this.ticketListContainer=this.shadowRoot.querySelector("#ticketListContainer"),this.ticketCountBadge=this.shadowRoot.querySelector("#ticketCountBadge"),this.btnNewTicketWelcome=this.shadowRoot.querySelector("#btnNewTicketWelcome"),this.chatEndBtn=this.shadowRoot.querySelector("#chatEndBtn"),this.chatResolvedBanner=this.shadowRoot.querySelector("#chatResolvedBanner"),this.chatStartNewBtn=this.shadowRoot.querySelector("#chatStartNewBtn"),this.chatComposerBox=this.shadowRoot.querySelector("#chatComposerBox"),this.identityCustCode=this.shadowRoot.querySelector("#identityCustCode"),this.identityNameInput=this.shadowRoot.querySelector("#identityNameInput"),this.identityEmailInput=this.shadowRoot.querySelector("#identityEmailInput"),this.identityEmailError=this.shadowRoot.querySelector("#identityEmailError"),this.identityContinueBtn=this.shadowRoot.querySelector("#identityContinueBtn"),this.identityBackBtn=this.shadowRoot.querySelector("#identityBackBtn"),this.identitySupportTag=this.shadowRoot.querySelector("#identitySupportTag"),this.chatInlineIdentityBanner=this.shadowRoot.querySelector("#chatInlineIdentityBanner"),this.inlineIdentityInput=this.shadowRoot.querySelector("#inlineIdentityInput"),this.inlineIdentityBtn=this.shadowRoot.querySelector("#inlineIdentityBtn"),this.socialPickerBackBtn=this.shadowRoot.querySelector("#socialPickerBackBtn"),this.offHoursBanner=this.shadowRoot.querySelector("#offHoursBanner")}bindEvents(){let t=()=>this.unlockAudio();this.launcherBtn.addEventListener("click",t),window.addEventListener("click",t,{passive:!0}),window.addEventListener("keydown",t,{passive:!0}),window.addEventListener("touchstart",t,{passive:!0}),this.launcherBtn.addEventListener("click",()=>{this.toggle()}),this.shadowRoot.querySelectorAll(".welcome-close-btn, .chat-close-btn").forEach(o=>{o.addEventListener("click",()=>this.close())});let e=this.shadowRoot.querySelector(".card-active-chat");e&&e.addEventListener("click",()=>{this.customerName?this.goToStage("chat"):this.goToStage("identity")}),this.chatEndBtn&&this.chatEndBtn.addEventListener("click",o=>{o.stopPropagation();let c=this.sessionData?.conversation?.id;c&&confirm(this.t.resolveConfirm)&&this.emitter.emit("conversation:resolve",c)}),this.chatStartNewBtn&&this.chatStartNewBtn.addEventListener("click",o=>{o.stopPropagation(),this.emitter.emit("conversation:start-new")}),this.btnNewTicketWelcome&&this.btnNewTicketWelcome.addEventListener("click",o=>{o.stopPropagation(),this.emitter.emit("conversation:start-new")}),this.identityBackBtn&&this.identityBackBtn.addEventListener("click",()=>{this.goToStage("welcome")}),this.socialPickerBackBtn&&this.socialPickerBackBtn.addEventListener("click",()=>{this.goToStage("welcome")});let i=()=>{let o=this.identityNameInput?this.identityNameInput.value.trim():"",c=this.identityEmailInput?this.identityEmailInput.value.trim():"";if(!c||!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(c)){this.identityEmailError&&(this.identityEmailError.style.display="block"),this.identityEmailInput&&(this.identityEmailInput.style.borderColor="#ef4444",this.identityEmailInput.focus());return}this.identityEmailError&&(this.identityEmailError.style.display="none"),this.identityEmailInput&&(this.identityEmailInput.style.borderColor=""),o&&this.applyCustomerName(o,!0),this.customerEmail=c,st(c),this.emitter.emit("customer:set-email",c),this.goToStage("chat")};this.identityContinueBtn&&this.identityContinueBtn.addEventListener("click",i),this.identityNameInput&&this.identityNameInput.addEventListener("keydown",o=>{o.key==="Enter"&&(o.preventDefault(),this.identityEmailInput&&this.identityEmailInput.focus())}),this.identityEmailInput&&(this.identityEmailInput.addEventListener("keydown",o=>{o.key==="Enter"&&(o.preventDefault(),i())}),this.identityEmailInput.addEventListener("input",()=>{this.identityEmailError&&(this.identityEmailError.style.display="none"),this.identityEmailInput&&(this.identityEmailInput.style.borderColor="")}));let a=this.shadowRoot.querySelector(".chat-back-btn");a&&a.addEventListener("click",()=>{this.goToStage("welcome")});let s=()=>{let o=this.inlineIdentityInput.value.trim();o&&this.applyCustomerName(o,!0)};this.inlineIdentityBtn&&this.inlineIdentityBtn.addEventListener("click",s),this.inlineIdentityInput&&this.inlineIdentityInput.addEventListener("keydown",o=>{o.key==="Enter"&&(o.preventDefault(),s())}),this.composerInput.addEventListener("input",()=>{this.composerInput.style.height="auto",this.composerInput.style.height=Math.min(this.composerInput.scrollHeight,90)+"px";let o=this.composerInput.value.trim().length>0;this.composerSendBtn.disabled=!o}),this.composerInput.addEventListener("keydown",o=>{o.key==="Enter"&&!o.shiftKey&&(o.preventDefault(),this.handleSend())}),this.composerSendBtn.addEventListener("click",()=>{this.handleSend()});let r=()=>{typeof window<"u"&&window.innerWidth<=640&&(setTimeout(()=>{this.updateViewportDimensions(),this.scrollToBottom(),this.currentStage==="chat"&&this.composerInput.scrollIntoView({block:"nearest",behavior:"smooth"})},100),setTimeout(()=>{this.updateViewportDimensions(),this.scrollToBottom()},300))};this.composerInput.addEventListener("focus",r),this.identityNameInput&&this.identityNameInput.addEventListener("focus",r)}initViewportHandler(){if(typeof window>"u")return;let t=()=>{this.isOpen&&this.updateViewportDimensions()};window.visualViewport&&(window.visualViewport.addEventListener("resize",t),window.visualViewport.addEventListener("scroll",t)),window.addEventListener("resize",t),window.addEventListener("orientationchange",()=>{setTimeout(t,200)})}updateViewportDimensions(){if(typeof window>"u")return;if(!(window.innerWidth<=640)){this.wrapperEl.style.removeProperty("--bt-viewport-height"),this.wrapperEl.style.removeProperty("--bt-viewport-top");return}if(window.visualViewport){let e=Math.round(window.visualViewport.height),i=Math.round(window.visualViewport.offsetTop);this.wrapperEl.style.setProperty("--bt-viewport-height",`${e}px`),this.wrapperEl.style.setProperty("--bt-viewport-top",`${i}px`)}else this.wrapperEl.style.setProperty("--bt-viewport-height",`${window.innerHeight}px`),this.wrapperEl.style.setProperty("--bt-viewport-top","0px")}handleSendText(t,e){let i=(t||"").trim();if(!i)return;this.composerInput.value="",this.composerInput.style.height="24px",this.composerSendBtn.disabled=!0;let a=e||i,s={id:Date.now(),conversation_id:this.sessionData?.conversation?.id||0,client_message_id:B(),sender_type:"visitor",sender_name:this.customerName||"Anda",content:a,message:i,created_at:new Date().toISOString()};this.appendMessage(s),this.emitter.emit("ui:send",s)}handleSend(){let t=this.composerInput.value.trim();t&&this.handleSendText(t)}goToStage(t){if(this.currentStage=t,t==="welcome")this.stageWelcome.style.display="flex",this.stageIdentity&&(this.stageIdentity.style.display="none"),this.stageSocialPicker&&(this.stageSocialPicker.style.display="none"),this.stageChat.style.display="none";else if(t==="identity")this.stageWelcome.style.display="none",this.stageIdentity&&(this.stageIdentity.style.display="flex"),this.stageSocialPicker&&(this.stageSocialPicker.style.display="none"),this.stageChat.style.display="none",this.identityNameInput&&(this.customerName&&(this.identityNameInput.value=this.customerName),setTimeout(()=>this.identityNameInput.focus(),150));else if(t==="social-picker")this.stageWelcome.style.display="none",this.stageIdentity&&(this.stageIdentity.style.display="none"),this.stageSocialPicker&&(this.stageSocialPicker.style.display="flex"),this.stageChat.style.display="none";else{if(this.stageWelcome.style.display="none",this.stageIdentity&&(this.stageIdentity.style.display="none"),this.stageSocialPicker&&(this.stageSocialPicker.style.display="none"),this.stageChat.style.display="flex",this.messages.length===0){let e=this.sessionData?.widget||this.sessionData?.widget_settings;if(e&&e.bot_enabled&&e.bot_welcome_message){let a=e.bot_mode_options!==!1&&Array.isArray(e.bot_welcome_options)&&e.bot_welcome_options.length>0?e.bot_welcome_options:null,s={id:0,conversation_id:this.sessionData?.conversation?.id||0,sender_type:"bot",sender_name:e.bot_name||"Assistant",content:e.bot_welcome_message,message:e.bot_welcome_message,metadata:{is_bot:!0,is_welcome:!0,options:a},created_at:new Date().toISOString()};this.appendMessage(s)}}this.scrollToBottom(),setTimeout(()=>this.composerInput.focus(),150)}this.updateViewportDimensions()}openSocialPicker(t,e){let i=this.shadowRoot.querySelector("#socialPickerTitle"),a=this.shadowRoot.querySelector("#socialPickerHeaderTitle"),s=this.shadowRoot.querySelector("#socialPickerHeroAvatar"),r=this.shadowRoot.querySelector("#socialPickerList"),o=Y(t);a&&(a.textContent=this.t.socialPickerHeader(o)),i&&(i.textContent=this.t.socialPickerTitle(o));let c=this.shadowRoot.querySelector("#socialPickerSubtitle");if(c&&(c.textContent=this.t.socialPickerSubtitle),s){let p=e[0]||{};s.innerHTML=G(p,t),s.className=`social-picker-avatar social-btn-${t}`}r&&(r.innerHTML="",e.forEach(p=>{let h=document.createElement("a");h.className="social-picker-item",h.href=p.url,h.target="_blank",h.rel="noopener noreferrer";let u=G(p,t),l=yt(p.url,t);h.innerHTML=`
      ...
      <div class="msg-time-status">
        <span>${s}</span>
        ${e?`<span style="display:inline-flex;">${d.check}</span>`:""}
      </div>
    `,u&&u.length>0&&!e){let v=a.querySelectorAll(".msg-option-btn");v.forEach((C,I)=>{C.addEventListener("click",P=>{P.preventDefault();let k=u[I];k&&(v.forEach(S=>S.disabled=!0),C.classList.add("is-selected"),this.handleSendText(k.value||k.label,k.label||k.value))})})}this.messagesArea.appendChild(a)}formatMessageContent(t){if(!t)return"";let e=w(t);return e=e.replace(/\*(.*?)\*/g,"<strong>$1</strong>"),e=e.replace(/(https?:\/\/[^\s]+)/g,'<a href="$1" target="_blank" rel="noopener noreferrer">$1</a>'),e=e.replace(/(^|[\s])(www\.[^\s]+)/g,'$1<a href="https://$2" target="_blank" rel="noopener noreferrer">$2</a>'),e}updateSnippet(){if(this.messages.length>0){let t=this.messages[this.messages.length-1],e=t.sender_type==="visitor"?`${this.t.senderYou}: `:"",i=t.content||t.message||"";this.cardSnippetText.textContent=e+i}}updateUnreadBadge(){this.unreadCount>0?(this.unreadBadge.textContent=this.unreadCount>9?"9+":this.unreadCount.toString(),this.unreadBadge.classList.add("has-unread")):this.unreadBadge.classList.remove("has-unread")}scrollToBottom(){setTimeout(()=>{this.messagesArea.scrollTop=this.messagesArea.scrollHeight},40)}formatTime(t){try{if(!t)return"";let e=t;typeof e=="string"&&!e.includes("Z")&&!e.includes("+")&&!e.includes("T")&&(e=e.replace(" ","T")+"Z");let i=new Date(e);if(isNaN(i.getTime()))return"";let a=String(i.getHours()).padStart(2,"0"),s=String(i.getMinutes()).padStart(2,"0");return`${a}:${s}`}catch{return""}}updateResolvedUI(t){t?(this.chatEndBtn&&(this.chatEndBtn.style.display="none"),this.chatComposerBox&&(this.chatComposerBox.style.display="none"),this.chatResolvedBanner&&(this.chatResolvedBanner.style.display="flex")):(this.chatEndBtn&&(this.chatEndBtn.style.display="inline-flex"),this.chatComposerBox&&(this.chatComposerBox.style.display="flex"),this.chatResolvedBanner&&(this.chatResolvedBanner.style.display="none"))}renderTicketsHistory(t){if(!(!this.cardTicketsContainer||!this.ticketListContainer)){if(!t||t.length===0){this.cardTicketsContainer.style.display="none";return}this.ticketListContainer.innerHTML="",this.ticketCountBadge&&(this.ticketCountBadge.textContent=this.t.ticketsCount(t.length)),t.forEach(e=>{let i=document.createElement("div");i.className="ticket-item";let a=e.status==="open"||e.status==="pending",s=a?"ticket-status-open":"ticket-status-closed",r=a?this.t.ticketStatusOpen:this.t.ticketStatusClosed,o=e.last_message_preview||this.t.ticketDefaultSnippet,c=this.formatTime(e.last_message_at||e.created_at);i.innerHTML=`
        <div class="ticket-item-left">
          <div class="ticket-item-title">
            <span>${this.t.ticketPrefix(e.id)}</span>
            <span class="ticket-status-badge ${s}">${r}</span>
      ...
      `,i.addEventListener("click",()=>{this.emitter.emit("conversation:switch",e.id)}),this.ticketListContainer.appendChild(i)}),this.cardTicketsContainer.style.display="flex"}}};function w(n){return n.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function G(n,t){if(n){let i=(n.custom_icon||"").trim();if((n.icon_type==="custom"||i!==""&&!n.icon_type)&&i)return i.startsWith("<svg")&&i.endsWith("</svg>")?i:`<img src="${w(i)}" alt="${w(n.name||t)}" />`}let e=n?.icon||t;return d[e]||d[t]||d.chat}function Y(n){return{whatsapp:"WhatsApp",instagram:"Instagram",threads:"Threads",x:"X (Twitter)",twitter:"X (Twitter)",facebook:"Facebook",messenger:"Facebook",tiktok:"TikTok",youtube:"YouTube",telegram:"Telegram",shopee:"Shopee Store",tokopedia:"Tokopedia Store",custom:"Link Kustom",link:"Tautan Kustom"}[n.toLowerCase()]||bt(n)}function yt(n,t){if(!n)return"";let e=t.toLowerCase();if(e==="whatsapp"){if(n.includes("wa.me/")){let i=n.split("wa.me/")[1]?.split("?")[0]||"";return i?`+${i}`:n}}else if(e==="instagram"){if(n.includes("instagram.com/")){let i=n.split("instagram.com/")[1]?.split("/")[0]?.split("?")[0]||"";return i?`@${i}`:n}}else if(e==="threads"){if(n.includes("threads.net/@")){let i=n.split("threads.net/@")[1]?.split("/")[0]?.split("?")[0]||"";return i?`@${i}`:n}else if(n.includes("threads.net/")){let i=n.split("threads.net/")[1]?.split("/")[0]?.split("?")[0]||"";return i?`@${i}`:n}}else if(e==="x"||e==="twitter"){if(n.includes("x.com/")){let i=n.split("x.com/")[1]?.split("/")[0]?.split("?")[0]||"";return i?`@${i}`:n}else if(n.includes("twitter.com/")){let i=n.split("twitter.com/")[1]?.split("/")[0]?.split("?")[0]||"";return i?`@${i}`:n}}else if(e==="facebook"||e==="messenger"){if(n.includes("facebook.com/")){let i=n.split("facebook.com/")[1]?.split("/")[0]?.split("?")[0]||"";return i||n}}else if(e==="tiktok"){if(n.includes("tiktok.com/@")){let i=n.split("tiktok.com/@")[1]?.split("/")[0]?.split("?")[0]||"";return i?`@${i}`:n}}else if(e==="youtube"){if(n.includes("youtube.com/@")){let i=n.split("youtube.com/@")[1]?.split("/")[0]?.split("?")[0]||"";return i?`@${i}`:n}}else if(e==="telegram"&&n.includes("t.me/")){let i=n.split("t.me/")[1]?.split("/")[0]?.split("?")[0]||"";return i?`@${i}`:n}return n}function bt(n){return n?n.charAt(0).toUpperCase()+n.slice(1):""}function vt(){if(typeof document>"u")return"";let n=document.currentScript;if(n&&n.src)try{return new URL(n.src,window.location.href).origin}catch{}let t=document.querySelector("script[data-project-key]");if(t&&t.src)try{return new URL(t.src,window.location.href).origin}catch{}let e=document.querySelector('script[src*="chat-widget.js"], script[src*="widget.js"]');if(e&&e.src)try{return new URL(e.src,window.location.href).origin}catch{}return""}if(typeof window<"u")try{console.log("%c[BeanTalk]%c Universal Chat Widget Started","background: #0071E3; color: #ffffff; padding: 2px 6px; border-radius: 4px; font-weight: bold;","color: inherit; font-weight: 500;")}catch{}var T=class{constructor(t){this.sessionData=null;this.initialized=!1;this.sendQueue=[];this.isSending=!1;this.options=t,this.emitter=new R,console.log("[BeanTalk] Initializing widget instance for project:",t.projectKey);let e=vt(),i=t.apiUrl||e||(typeof window<"u"?window.location.origin:"");this.api=new H(t.projectKey,i),this.ui=new $(t,this.emitter),this.transport=new _(this.api,this.emitter),this.bindEvents(),this.bootstrap()}isReady(){return this.initialized}async processSendQueue(){if(!(this.isSending||this.sendQueue.length===0)){for(this.isSending=!0;this.sendQueue.length>0;){let t=this.sendQueue.shift(),e=this.sessionData?.conversation?.id||0,i=this.options.visitorUuid||A(),a=E();try{let s=await this.api.sendMessage(e,{visitor_uuid:i,client_message_id:t.client_message_id||B(),message:t.content||t.message||"",sender_name:t.sender_name||a||(this.options.language==="en"?"Guest":"Tamu"),page_url:window.location.href,page_title:document.title});if(s.success&&s.data){let r=s.data.conversation_id;if(r&&(!this.sessionData?.conversation?.id||this.sessionData.conversation.id!==r)){this.sessionData||(this.sessionData={});let o=this.sessionData;o.conversation?(o.conversation.id=r,o.conversation.status="open"):o.conversation={id:r,status:"open"},this.ui.sessionData=o,this.ui.updateResolvedUI(!1),F(r),this.transport.start(r,s.data.id||0)}this.emitter.emit("message:sent",s.data)}}catch(s){console.error("[BeanTalk] Gagal mengirim pesan:",s)}}this.isSending=!1,this.transport.pollNow()}}bindEvents(){this.emitter.on("ui:send",t=>{this.sendQueue.push(t),this.processSendQueue()}),this.emitter.on("customer:rename",async t=>{let e=this.options.visitorUuid||A();try{await this.api.updateProfile(e,t)}catch(i){console.warn("[BeanTalk] Gagal update nama profil pengunjung:",i)}}),this.emitter.on("message:received",t=>{this.ui.appendMessage(t),this.emitter.emit("message",t)}),this.emitter.on("widget:opened",()=>{this.transport.setWidgetOpen(!0),this.transport.pollNow()}),this.emitter.on("widget:closed",()=>{this.transport.setWidgetOpen(!1)}),this.emitter.on("conversation:resolve",async t=>{let e=this.options.visitorUuid||A();try{if((await this.api.resolveConversation(t,e)).success){this.sessionData&&this.sessionData.conversation&&(this.sessionData.conversation.status="closed"),this.ui.updateResolvedUI(!0);let a=this.options.language==="en";this.ui.appendMessage({id:Date.now(),conversation_id:t,sender_type:"system",sender_name:"System",content:a?'You have marked this conversation as resolved. Click "Start New Chat" to open a new ticket.':'Percakapan ini telah Anda tandai selesai. Klik "Mulai Chat Baru" untuk membuat tiket baru.',created_at:new Date().toISOString()});let s=await this.api.getConversations(e);s.success&&s.data?.conversations&&(this.sessionData={...this.sessionData,conversations:s.data.conversations},this.ui.renderTicketsHistory(s.data.conversations))}}catch(i){console.error("[BeanTalk] Gagal menyelesaikan tiket:",i)}}),this.emitter.on("conversation:start-new",()=>{this.sessionData&&(this.sessionData.conversation=null),F(0),this.transport.stop(),this.ui.setMessages([]),this.ui.updateResolvedUI(!1),E()?this.ui.goToStage("chat"):this.ui.goToStage("identity")}),this.emitter.on("conversation:switch",async t=>{try{let e=await this.api.pollMessages(t,0);if(e.success&&e.data){this.sessionData||(this.sessionData={});let i=this.sessionData,s=(i.conversations||[]).find(r=>r.id===t)?.status||"open";i.conversation={id:t,status:s},F(t),this.ui.setMessages(e.data.messages||[]),this.ui.updateResolvedUI(s==="closed"),this.ui.goToStage("chat"),s!=="closed"?this.transport.start(t,e.data.last_id||0):this.transport.stop()}}catch(e){console.error("[BeanTalk] Gagal memuat percakapan tiket:",e)}})}async bootstrap(){let t=this.options.visitorUuid||A(),e=E();try{let i=await this.api.initSession(t,void 0,e||void 0);if(i.success&&i.data){this.sessionData=i.data;let a=i.data.widget||i.data.widget_settings;a&&(a.language==="en"||a.language==="id")&&(this.options.language=a.language),this.ui.setSessionData(i.data);let s=i.data.conversation;if(s&&s.id){F(s.id);let r=0;s.messages&&s.messages.length>0&&(r=Math.max(...s.messages.map(o=>o.id))),this.transport.start(s.id,r),s.status!=="closed"&&(this.ui.goToStage("chat"),(!s.messages||s.messages.length===0)&&this.transport.pollNow())}this.initialized=!0,console.log("[BeanTalk] Session established successfully:",{brand:i.data.project?.name,customerCode:i.data.visitor?.customer_code,conversationId:i.data.conversation?.id||"New Thread"}),this.emitter.emit("ready",i.data)}else console.warn("[BeanTalk] Init session warning:",i.error?.message)}catch(i){console.error("[BeanTalk] Failed to initialize chat session:",i)}}open(){console.log("[BeanTalk] Opening chat widget window"),this.ui.open()}close(){console.log("[BeanTalk] Closing chat widget window"),this.ui.close()}toggle(){this.ui.toggle()}on(t,e){return this.emitter.on(t,e),this}sendMessage(t){if(!t.trim())return;let e={id:Date.now(),conversation_id:this.sessionData?.conversation?.id||0,client_message_id:B(),sender_type:"visitor",sender_name:"Anda",content:t.trim(),message:t.trim(),created_at:new Date().toISOString()};this.ui.appendMessage(e),this.emitter.emit("ui:send",e)}setLanguage(t){let e=t==="en"?"en":"id";this.options.language=e,this.ui.setLanguage(e)}},xt=T,y=null,wt=n=>m.init(n),kt=()=>m.open(),Et=()=>m.close(),Ct=()=>m.toggle(),Tt=(n,t)=>m.on(n,t),St=n=>m.sendMessage(n),Bt=n=>m.setLanguage(n),At=()=>m.getInstance(),m={init(n){return y||(console.log("[BeanTalk] Creating singleton widget instance"),y=new T(n)),y},open(){y?y.open():console.warn("[BeanTalk] Widget instance not yet initialized")},close(){y?.close()},toggle(){y?.toggle()},on(n,t){y?.on(n,t)},sendMessage(n){y?.sendMessage(n)},setLanguage(n){y?.setLanguage(n)},getInstance(){return y}};if(typeof window<"u"){let n=function(){let t=document.querySelectorAll("script[data-project-key]");if(t.length>0){let e=t[0],i=e.getAttribute("data-project-key"),a="";if(e.src)try{a=new URL(e.src,window.location.href).origin}catch{}let s=e.getAttribute("data-api-url")||a||void 0,r=e.getAttribute("data-color")||void 0,o=e.getAttribute("data-brand-name")||e.getAttribute("data-store-name")||void 0,c=e.getAttribute("data-support-title")||void 0,p=e.getAttribute("data-lang")||e.getAttribute("data-language"),h=p==="en"||p==="id"?p:void 0;console.log("[BeanTalk] Found embed tag on page:",{projectKey:i,apiUrl:s,brandName:o,language:h}),i&&!y&&m.init({projectKey:i,apiUrl:s,accentColor:r,brandName:o,storeName:o,supportTitle:c,language:h})}};It=n,window.ChatWidget=m,window.UniversalChatMe=T,setTimeout(()=>{try{window.BeanTalk&&Object.assign(window.BeanTalk,m)}catch{}},0),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()}var It,Ft=m;return ut(Lt);})();
